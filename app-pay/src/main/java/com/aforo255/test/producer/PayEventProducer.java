package com.aforo255.test.producer;
...
public class PayEventProducer {
	...
	public ListenableFuture<SendResult<Integer, String>> sendDepositEvent(Operation operationEvent)
			throws JsonProcessingException {
		Integer key = operationEvent.getId_operation();
	...
	private void handleSuccess(Integer key, String value, SendResult<Integer, String> result) throws JsonMappingException, JsonProcessingException {
		//OperationRedis trxRedis = objectMapper.readValue(value, OperationRedis.class);
		_service.save(objectMapper.readValue(value, Operation.class));
